...
//Command     : generate_target pmod_color_ip_block_wrapper.bd
//Design      : pmod_color_ip_block_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module pmod_color_ip_block_wrapper
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  IOBUF Pmod_out_0_pin9_iobuf
       (.I(Pmod_out_0_pin9_o),
        ...
        .O(Pmod_out_0_pin9_i),
        .T(Pmod_out_0_pin9_t));
  pmod_color_ip_block pmod_color_ip_block_i
       (.DDR_addr(DDR_addr),
        .DDR_ba(DDR_ba),
        .DDR_cas_n(DDR_cas_n),
        .DDR_ck_n(DDR_ck_n),
